...
3. What does the `Content-Type: application/json` header tell the server?
...
6. Why should a server return different HTTP status codes for different situations?
